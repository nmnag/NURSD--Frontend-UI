        ...
        <div >
            ...
            <Container style={{ width: "800px", marginTop: "5rem" }}>
                <form>
                    ...
                    <p className="newfont" style={{ marginTop: "2rem",marginLeft:"13rem"}}> Enter the verification code sent to you on your<br />registered Email address</p>
                {/* 4 input fields to enter the four digit otp  */}
                  {/* event handlers for restricting input fields to numbers to be written */}
                    <div>
                        <input style={{ marginLeft: "19rem",marginTop: "1rem" }}type="text" className="digit-group" id="digit-1" name="digit-1" data-next="digit-2" placeholder="2"  maxlength="1" returnKeyType={"next"} />
                        ...
                        <input type="text" className="digit-group" id="digit-4" name="digit-4" data-previous="digit-3" placeholder="2"  maxlength="1"/>
                            ...
                            <div>
                                <p className="ffoont" style={{ marginTop: "2rem",marginLeft:"13rem" }}> Didn't recieve the code? <u>Resend</u> Wait for (<b>1:57</b>)</p>
                            </div>
                        
                    <div>
                        <button className="button" type="submit" style={{ marginTop:"3rem",marginLeft:"31rem"}}>Next</button>
                    </div>
                </form>
            </Container>
