...
return(
   ...
   >
     ...
     <div className={classes.drawerContainer}>
       ...
       <div>
       <p className="list"> Upcoming shifts </p>
       <p className="list"> Completed shifts </p>
       <p className="list"> Saved shifts</p>
          ...
          <Container style={{width: "40rem", height:'1000px'}}>
                    ...
                    <p style={{marginBottom:'10px'}}className="up"> Saved Shifts for </p>
